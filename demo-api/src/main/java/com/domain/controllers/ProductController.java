...
public class ProductController {
    ...
    @PostMapping(value = "/{id}", consumes = {"application/json", "application/json;charset=UTF-8"})
    public void addSupplier(@RequestBody Supplier supplier, @PathVariable("id") long productId) {
        productService.addSupplier(supplier, productId);
    }

    // Search for a product by exact name
    @PostMapping(value = "/search/name", consumes = {"application/json", "application/json;charset=UTF-8"})
    ...
    @PostMapping(value = "/search/namelike", consumes = {"application/json", "application/json;charset=UTF-8"})
